...
const THEMES = [
  ...
  { id: 'light', label: 'Light', colors: 'from-blue-50 via-white to-purple-50' },
  { id: 'ocean', label: 'Ocean', colors: 'from-cyan-900 via-blue-900 to-indigo-900' },
  { id: 'sunset', label: 'Sunset', colors: 'from-orange-900 via-red-900 to-purple-900' },
  { id: 'forest', label: 'Forest', colors: 'from-green-900 via-emerald-900 to-teal-900' },
];
          ...
          <div className="p-6">
            ...
            {mode === 'create' ? (
              <form onSubmit={handleCreate} className="space-y-4">
                ...
                <div>
                  ...
                  <input
                    ...
                    placeholder="My Chat Room (optional)"
                    maxLength={50}
                    className="w-full px-4 py-3 bg-white/10 border border-white/20 rounded-xl text-white placeholder-white/40 focus:outline-none focus:ring-2 focus:ring-purple-400 focus:border-transparent transition-all"
                  />
                </div>
              ...
              <form onSubmit={handleJoin} className="space-y-4">
                ...
                <button
                  type="submit"
                  disabled={!username.trim() || !joinRoomId.trim() || loading}
